...
--
-- Table structure for table `snapshots_140214`
--

CREATE TABLE IF NOT EXISTS `snapshots_140214` (
...
--
-- Dumping data for table `snapshots_140214`
--

INSERT INTO `snapshots_140214` (`snapId`, `flatId`, `bId`, `sectId`, `extFlatId`, `flStatus`, `flPrice`, `snapDate`) VALUES
